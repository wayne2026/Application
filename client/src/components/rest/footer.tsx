const Footer = () => {
    return (
        <div className='flex justify-center items-center mt-16 bg-[#5f5fc2] tilted-top'>
            <div className='flex max-md:flex-col justify-center md:p-24 mb-20 p-10 mx-auto w-[90%] '>
                <div className="flex   lg:w-1/2 max-lg:gap-10 ">
                    <div className='flex md:mr-16 gap-6 flex-col w-1/2 mt-36 '>
                        <h2 className='text-white md:text-2xl font-medium'><span className='text-blue-300'>VOOLATA</span> Foundation  </h2>
                    ...
                    <div className='flex gap-6 flex-col w-1/2 mt-36 '>

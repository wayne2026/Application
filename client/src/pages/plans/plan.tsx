...
const PlanPage = () => {
    ...
    return (
        ...
        //     </div>
        // </div>
        <div className="mt-6 h-screen bg-gradient-to-br from-[#efe8fa] to-[#fcfafd]">
            <div className="flex flex-col items-center ">
                <h1 className="text-5xl mt-10 font-semibold">Choose your right plan!</h1>
                <h2 className="text-center pb-16 pt-5 text-lg text-gray-600">Select from best plans, ensuring a perfect match, Need more or less? <br /> Customize your subscription for a seamless fit!</h2>
                <div className="flex justify-center gap-6">
                    <div className="w-96 shadow-[0px_4px_36px_0px_rgba(0,_0,_0,_0.1)] bg-[#fffdfd] p-8 rounded-2xl">
                        <button className="w-16 mb-5 bg-[#8547ff] h-9 rounded-xl  text-white font-medium">Basic</button>
                        <p className="pb-10 text-gray-600">The Starting Plan of Voolata.com, best for beginners and those seeking to explore more on this site Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae, blanditiis?</p>
                        <h1 className="text-5xl"> <span className="font-semibold">Rs. 29</span> <span className="text-sm">Once in 1 month</span></h1>
                    ...
                    <div className="w-96 bg-[#fffdfd] shadow-[0px_4px_36px_0px_rgba(0,_0,_0,_0.1)] p-8 rounded-2xl">
                    ...
                    <div className="w-96 p-8 rounded-2xl shadow-[0px_4px_36px_0px_rgba(0,_0,_0,_0.1)] bg-gradient-to-b from-[#e1d7fa] to-[#ffffff] ">
                        <button className="w-20 mb-5 h-9 rounded-xl font-bold text-black bg-white">Custom</button>
                        <p className="pb-10 text-gray-700">If these plans don't fit, let's create one that suits. Customize your subscription for a perfect fit, bigger or smaller</p>
                        <h1 className="text-5xl mb-5 pt-7"> <span className="font-semibold">Let's Talk !</span></h1>
                        <hr />
                        <h1 className="pt-5">Details:</h1>
                        <ul className="outline-none pb-5">
                            <li>Cards: 50</li>
                        ...
                        <hr />
                        <button className="w-full h-12 font-semibold rounded-xl mt-10 bg-[#2b233b] text-white">Get Started</button>
                    </div>
